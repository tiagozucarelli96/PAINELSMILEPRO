    ...
    try {
        switch ($action) {
            ...
            case 'atualizar_tipo_evento_real':
                ...
                if (!empty($updated['ok'])) {
                    if ($tipo_evento_real === 'infantil') {
                        $padrao_portal = eventos_cliente_portal_aplicar_padrao_infantil($pdo, $meeting_id);
                    } else {
                        $padrao_portal = eventos_cliente_portal_aplicar_padrao_nao_infantil($pdo, $meeting_id);
                    }
