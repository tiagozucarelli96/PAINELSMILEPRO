        ...
        <aside class="notif-panel">
            ...
            <div class="notif-list">
                <?php foreach ($modelos as $modelo): ?>
                    <?php $href = ((string)$modelo['chave'] === 'portal_cliente_lancamento') ? 'cliente_notificacoes_portal.php' : ('cliente_notificacoes.php?modelo_chave=' . urlencode((string)$modelo['chave'])); ?>
            ...
            <section class="notif-panel notif-campaign">
                ...
                <div class="notif-campaign-actions">
                    ...
                    <div style="display:flex;gap:.6rem;flex-wrap:wrap;justify-content:flex-end;">
                        <a class="notif-btn secondary" href="cliente_notificacoes_portal.php?consultar_publico=1">Consultar público na ME</a>
