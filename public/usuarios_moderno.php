<?php
// usuarios_moderno.php — Interface moderna de usuários com integração RH
if (session_status() === PHP_SESSION_NONE) { session_start(); }
require_once __DIR__ . '/conexao.php';
require_once __DIR__ . '/lc_permissions_unified.php';

// Verificar permissões
lc_check_permission('usuarios', 'dashboard.php');
        ...
        <div class="users-container">
            ...
            <div class="search-bar">
                <input type="text" class="search-input" placeholder="Pesquisar por nome, login ou email..." 
                       value="<?= htmlspecialchars($search) ?>" onkeyup="searchUsers(this.value)">
                ...
                <?php foreach ($usuarios as $user): ?>
                    <div class="user-card">
                        <div class="user-header">
                            ...
                            <div class="user-info">
                                <h3><?= htmlspecialchars($user['nome'] ?? 'Sem nome') ?></h3>
                                <p><?= htmlspecialchars($user['login'] ?? 'Sem login') ?></p>
                            </div>
                        </div>
                        ...
                        <div class="user-details">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value"><?= htmlspecialchars($user['cargo'] ?? '—') ?></span>
                            </div>
                            <div class="detail-row">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value"><?= htmlspecialchars($user['pix_chave'] ?? '—') ?></span>
                            </div>
                        </div>
