...
<script>
/* Desativa efeitos agressivos do preflight que podem mexer em img/body */
window.tailwind = {
  config: {
    theme: {
      extend: {
    ...
    corePlugins: { preflight: false } // importante pra não “esticar” imagens/logos
  }
};
</script>
...
/* Garante que a sidebar apareça e o conteúdo respeite a largura dela */
<?php if ($temSidebar): ?>
body.has-sidebar .main-content { margin-left: var(--sidebar-w); }
<?php endif; ?>

/* Se tua sidebar for position:fixed na esquerda, isso evita sobreposição */
.sidebar{ display:block !important; visibility:visible !important; }

/* Limite seguro para logos no header/aside */
header img, .logo img, img.site-logo { max-height:72px !important; height:auto !important; width:auto !important; }
...
<body class="bg-gray-50 min-h-screen <?php echo $temSidebar ? 'has-sidebar' : ''; ?>">
